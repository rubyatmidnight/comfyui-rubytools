...
class CharacterCard:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "name": ("STRING", {"default": "", "tooltip": "Character name and base file name"}),
            },
            "optional": {
                "species": ("STRING", {"default": "", "tooltip": "Character species"}),
                "role": ("STRING", {"default": "", "tooltip": "Narrative role or class"}),
                "pronouns": ("STRING", {"default": "", "tooltip": "Preferred pronouns"}),
                "age": ("STRING", {"default": "", "tooltip": "Age or age range"}),
                "height": ("STRING", {"default": "", "tooltip": "Height description"}),
                "weight": ("STRING", {"default": "", "tooltip": "Weight description"}),
                "eye_color": ("STRING", {"default": "", "tooltip": "Eye color"}),
                "hair_color": ("STRING", {"default": "", "tooltip": "Hair color"}),
                "skin": ("STRING", {"default": "", "tooltip": "Skin tone or traits"}),
                "traits": ("STRING", {"multiline": True, "default": "", "tooltip": "Trait bullets, one per line"}),
                "personality": ("STRING", {"multiline": True, "default": "", "tooltip": "Personality bullets, one per line"}),
                "backstory": ("STRING", {"multiline": True, "default": "", "tooltip": "Backstory bullets, one per line"}),
                "abilities": ("STRING", {"multiline": True, "default": "", "tooltip": "Abilities, one per line"}),
                "likes": ("STRING", {"multiline": True, "default": "", "tooltip": "Likes, one per line"}),
                "dislikes": ("STRING", {"multiline": True, "default": "", "tooltip": "Dislikes, one per line"}),
                "notes": ("STRING", {"multiline": True, "default": "", "tooltip": "Extra notes, one per line"}),
                "memory_entries": ("STRING", {"multiline": True, "default": "", "tooltip": "Initial memory entries, one per line"}),
                "experience_entries": ("STRING", {"multiline": True, "default": "", "tooltip": "Initial experience entries, one per line"}),
                "memory_dir": ("STRING", {"default": "", "tooltip": "Optional subfolder under characters"}),
            },
        }
